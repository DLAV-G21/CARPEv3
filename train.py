...
def main(args):
    ...
    data_loader_train = DataLoader(dataset_train, batch_sampler=batch_sampler_train,shuffle=True,
                                   collate_fn=utils.collate_fn, num_workers=args.num_workers)
    data_loader_val = DataLoader(dataset_val, args.batch_size, sampler=sampler_val,shuffle=False,
